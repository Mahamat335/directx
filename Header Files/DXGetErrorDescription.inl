...
switch (hr) {
  ...
  CHK_ERR(DDERR_INCOMPATIBLEPRIMARY, "Unable to match primary surface creation "
                                     "request with existing primary surface.")
  ...
  CHK_ERR(DDERR_NOMIRRORHW, "Operation could not be carried out because there "
                            "is no hardware present or available.")
  CHK_ERR(DDERR_NOTFOUND, "Requested item was not found")
  CHK_ERR(DDERR_NOOVERLAYHW, "Operation could not be carried out because there "
                             "is no overlay hardware present or available.")
  CHK_ERR(
  ...
  CHK_ERR(DDERR_NOROTATIONHW,
          ...
          "hardware present or available.")
  CHK_ERR(DDERR_NOSTRETCHHW, "Operation could not be carried out because there "
                             "is no hardware support for stretching")
  ...
  CHK_ERR(DDERR_NOZBUFFERHW, "Operation could not be carried out because there "
                             "is no hardware support for zbuffer blting.")
  ...
  CHK_ERR(DDERR_PALETTEBUSY, "Access to this palette is being refused because "
                             "the palette is already locked by another thread.")
  CHK_ERR(DDERR_COLORKEYNOTSET,
          "No src color key specified for this operation.")
  CHK_ERR(DDERR_SURFACEALREADYATTACHED, "This surface is already attached to "
  ...
  CHK_ERR(DDERR_SURFACEBUSY, "Access to this surface is being refused because "
                             "the surface is already locked by another thread.")
  CHK_ERR(
  ...
  CHK_ERR(DDERR_TOOBIGSIZE, "Size requested by DirectDraw is too large --  The "
  ...
  CHK_ERR(DDERR_NOHWND, "Clipper notification requires an HWND or no HWND has "
  ...
  CHK_ERR(DDERR_NOFOCUSWINDOW, "Attempt was made to create or set a device "
                               "window without first setting the focus window")
  ...
  CHK_ERR(DXGI_ERROR_NOT_FOUND,
          ...
          "with the object.")
  CHK_ERR(DXGI_ERROR_MORE_DATA, "The specified size of the destination buffer "
                                "is too small to hold the requested data.")
